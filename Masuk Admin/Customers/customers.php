   ...
   <section class="home-section">
      ...
      <div class="home-content">
         ...
         <button type="button" class="btn btn-tambah">
            <a href="../Customers/entry_customers.php">Tambah Data</a>
         </button>

         <button type="button" class="btn">
            <a href="customers_cetak.php">Cetak</a>
         </button>
         ...
         <table class="table-data">
            <thead>
               <tr>
                  <th scope="col" style="width: 15%">Nama Toko</th>
                  <th scope="col" style="width: 20%">Email</th>
                  <th scope="col" style="width: 15%">Telp</th>
			   ...
			   <tr>
				<td colspan='5' style='text-align: center'>Tidak ada data</td>
                 ...
                 <td>$data[tanggal]</td>
				     ...
				     <td>
                     <a href=customers-edit.php?id=$data[id]>Edit</a> |
                     <a href=customers-hapus.php?id=$data[id]>Hapus</a>
                  </td>
				   </tr>
				   ";
                  }
